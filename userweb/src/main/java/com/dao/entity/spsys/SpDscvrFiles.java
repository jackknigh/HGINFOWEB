...
/**
 * @title [事件表]
 * @ClassName: SpDscvrFiles
 * @description [事件表]
 * @author ank
 * @version v 1.0
 * @create 2018/9/6 18:09
 * @copyright Copyright(C) 2018 SHIPING INFO Corporation. All rights reserved.
 */
public class SpDscvrFiles implements Serializable
{

    private static final long serialVersionUID = -2236510514736238294L;
    /**
     * 主键
     */
    private String id;
