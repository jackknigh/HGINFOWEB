...
public class ResponseMessage implements Serializable {
     ...
     *</ul>
     */
    public static ResponseMessage sendPkError(){
        ResponseMessage message = new ResponseMessage();
        message.setCode(RspCode.PKFAILURE.getCode());
        message.setMsg(RspCode.PKFAILURE.getDescription());
        message.setBean("");
        return message;
    }
    ...
    */
     ...
     *</ul>
     */
    public static ResponseMessage sendError(Object bean){
        ResponseMessage message = new ResponseMessage();
        message.setCode(RspCode.FAILURE.getCode());
        message.setMsg(RspCode.FAILURE.getDescription());
