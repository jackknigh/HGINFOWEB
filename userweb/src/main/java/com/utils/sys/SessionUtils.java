...
public class SessionUtils {
     ...
     */
    public static String accountIdCheck(String accountId) {
        if (true) {
            return "";
        }
        ...
        LoginUserBean loginUserBean = (LoginUserBean) getSessionAttribute(SessionItem.loginUserBean.name());
        if (TextUtils.isEmpty(loginUserBean)) {
            return "登录已过期，请重新登陆";
        }
        if (!accountId.equals(loginUserBean.getAccountId())) {
            return "帐套名称不匹配";
        }
        return "";
    }
