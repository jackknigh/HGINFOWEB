...
public class CompareRunnable1 implements Runnable {
    ...
    public CompareRunnable1(int num, int str,CountDownLatch countDownLatch,String streetName) {
        this.num = num;
        this.str = str;
    ...
    public void run() {
        //获取每个街道的数据
        List<Base_addr> baseAddrList = base_addrMapper.selectBaseAddrByStreet(streetName);
