...
public class StrUtil {
    ...
    public static String encode(String inputStr) {
        ...
        String tempStr = "";
        try {
            tempStr = new String(inputStr.getBytes(StandardCharsets.ISO_8859_1));
        } catch (Exception ex) {
    ...
    public static boolean isEmpty(String str) {
        return str == null || "".equals(str) || "".equals(str.trim()) || "null".equals(str) || "undefined".equals(str);
    }
    ...
    public static Double parseDouble(String f) {
        try {
            DecimalFormat df = new DecimalFormat("#,##0.0#");
            return Double.valueOf(String.valueOf(df.parseObject(f)));
        } catch (Exception e) {
    ...
    public static String capitalize(String data, int pos) {
        ...
        buf.append(data, 0, pos - 1);
        buf.append(data.substring(pos - 1, pos).toUpperCase());
        buf.append(data, pos, data.length());
        return buf.toString();
    }
    ...
    public static String replaceAll(String source, String info, String tag) {
        ...
        while (valid) {
            ret.append(source, start, index).append(info);
            start = index + length;
    ...
    public static String replaceAll(String source, String info,
        ...
        while (valid) {
            ...
            ret.append(source, start, sIndex + 1).append(info)
                    .append(endTag);
            start = eIndex + 1;
    ...
    public static final String filterHalfWord(String sourceStr)
        ...
        for (int i = 0; i < cc.length; i++) {
            byte[] c = String.valueOf(cc[i]).getBytes(StandardCharsets.UTF_8);
    ...
    public static String getRandom18Str() {
        String random18Str = "";
        random18Str = (System.currentTimeMillis() + "" + Math
    ...
    public static void main(String[] args) {
        ...
        List<String> attachIdList = splitList("", ',');
