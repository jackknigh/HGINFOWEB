...
{
	public static final String DATA_ZIP_PWD = "vmjiow98ikd098ki";
	...
	public static String extractFile(String zipFilePath, String fileName, String dstDir)
	{
		try
		{
			ZipFile zipFile = new ZipFile(zipFilePath);
			zipFile.extractFile(fileName, dstDir);
			return dstDir + File.separator + fileName;
		}
		catch (ZipException e)
		{
			e.printStackTrace();
	...
	public static void updateZipFile(String zipFilePath, String replacePath, File file)
	{
		try
		{
			ZipFile zipFile = new ZipFile(zipFilePath);
			...
			parameters.setRootFolderInZip(replacePath);
