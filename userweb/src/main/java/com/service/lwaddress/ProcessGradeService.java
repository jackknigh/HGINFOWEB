...
public interface ProcessGradeService {
    ...
    /*实际值算法*/
    Integer[] processSum(String[] a1, String[] a2, int n,boolean flag);
    /*算法Demo*/
    Map<String,Object>  processDemo(Map<String, String[]> strMap, int n,boolean flag);
    /*单字符或者数组的总分*/
    BigDecimal processSingleSum(Integer[] a1);
    /*计算Integer[]的总和*/
    Map<String,Object> processCount(String a1[], String a2[], int n,boolean flag);
    /*相似度得分计算*/
